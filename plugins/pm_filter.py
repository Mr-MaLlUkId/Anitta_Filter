...
import ast
import math
from pyrogram.errors.exceptions.bad_request_400 import MediaEmpty, PhotoInvalidDimensions, WebpageMediaEmpty, InputMediaPhoto
...
async def advantage_spoll_choker(bot, query):
    ...
    if not movies:
        return await query.answer("𝗬𝗼𝘂 𝗮𝗿𝗲 𝗖𝗹𝗶𝗰𝗸𝗶𝗻𝗴 𝗼𝗻 𝗮𝗻 𝗢𝗹𝗱 𝗕𝘂𝘁𝘁𝗼𝗻 𝘄𝗵𝗶𝗰𝗵 𝗜𝘀 𝗘𝘅𝗽𝗶𝗿𝗲𝗱.", show_alert=True)
    movie = movies[(int(movie_))]
    await query.answer('𝗖𝗻𝗲𝗰𝗸𝗶𝗻𝗴 𝗙𝗼𝗿 𝗠𝗼𝘃𝗶𝗲 𝗜𝗻 𝗗𝗮𝘁𝗮𝗯𝗮𝘀𝗲...💡')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('• 𝗖𝗼𝗻𝗻𝗲𝗰𝘁 •', callback_data='coct'),
        ...
        buttons = [[
            InlineKeyboardButton('🥀 𝗨𝗽𝗱𝗮𝘁𝗲𝘀 🥀', url='https://t.me/CINEMACLUBLINKZ'),
            InlineKeyboardButton('📊 𝗦𝘁𝗮𝘁𝗲𝘀 📊', callback_data='stats')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('⇚ 𝗕𝗮𝗰𝗸', callback_data='help'),
            InlineKeyboardButton('𝗕𝘂𝘁𝘁𝗼𝗻𝘀 ⏹️', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        if settings is not None:
            buttons = [
                [
                    InlineKeyboardButton('▪️𝗙𝗶𝗹𝘁𝗲𝗿 𝗕𝘂𝘁𝘁𝗼𝗻',
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>○ 𝖧𝖾𝗋𝖾 𝗂𝗌 𝗐𝗁𝖺𝗍 𝗂 𝖿𝗈𝗎𝗇𝖽 𝖿𝗈𝗋 𝗒𝗈𝗎𝗋 𝗊𝗎𝖾𝗋𝗒</b> - <b><u>{search}</u></b>"
